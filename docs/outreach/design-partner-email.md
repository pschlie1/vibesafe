...
*Use these to find the first 3-5 paying design partners. Target: IT Directors and CISOs at companies with 100-1,000 employees who have adopted Cursor or similar AI dev tools.*
...
Looking for 3-4 IT leaders at companies using AI dev tools to shape the product before we push harder on growth. Free for 90 days, direct line to the team, your use cases influence what gets built next.
...
Are you running into this problem in your org?

[Your name]

---

## Template 3: MSP / Agency angle

**Subject:** Monitoring AI-built apps for your clients
...
## Target List (research starting points)

**LinkedIn search queries:**
- "IT Director" + "Cursor" (people who mention Cursor in their profile/posts)
- "CISO" + "AI development" + company size 100-1,000
...
- Has compliance requirements (SOC2, HIPAA, ISO, PCI)
- Has > 10 developers
- IT leader has budget authority (Director level or above)
- NOT a pure security company (they'll want deep pentesting, not governance)
