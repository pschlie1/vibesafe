...
export default function VibeCodingSecurityRisksPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What are the security risks of AI-assisted coding?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "AI coding assistants can generate code with security vulnerabilities including SQL injection, hardcoded credentials, insecure authentication patterns, and missing input validation. The code looks correct syntactically but may contain known vulnerability patterns that the model learned from flawed examples."
      }
    },
    {
      "@type": "Question",
      "name": "How do I check AI-generated code for security issues?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Treat AI-generated code the same as any other code: run static analysis, dependency checks, and API security scans before deploying. Don't assume AI-generated code is secure because it looks clean. Run Scantient against any API routes generated by AI tools."
      }
    },
    {
      "@type": "Question",
      "name": "Does vibe coding increase security debt?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It can if security checks are not part of the development flow. Developers shipping AI-generated code quickly without security review accumulate vulnerabilities faster than traditional development. Automated scanning in CI is the counterbalance."
      }
    }
  ]
}) }}
