...
export const metadata: Metadata = {
  ...
  description:
    "Run a free API vulnerability scan and security audit on your site in 60 seconds. No signup, no SDK. Paste your URL and get instant results. Scantient checks 20 security controls.",
  openGraph: {
    title: "Free API Security Scan: Check Your Site in 60 Seconds | Scantient",
    description:
      "Free API security scanner. Paste your URL and get a full security audit in 60 seconds. 20 checks, no signup, no installation required.",
  ...
  twitter: {
    ...
    title: "Free API Security Scan: Check Your Site in 60 Seconds | Scantient",
    description:
      "Free API security scanner. Paste your URL, get results in 60 seconds.",
  },
};
