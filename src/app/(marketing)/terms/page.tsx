    ...
    <>
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-12 space-y-8 text-sm leading-relaxed text-body">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">2. Description of service</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">3. Permitted use</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">4. Accounts and access</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">5. Subscriptions and billing</h2>
            <div className="mt-3 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">6. Service availability</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">7. Data and privacy</h2>
            <p className="mt-3">
              Your use of the Service is subject to our <Link href="/privacy" className="text-heading underline hover:no-underline">Privacy Policy</Link>. Scan results and account data are yours. We do not sell your data or use it to train AI models.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-heading">8. Intellectual property</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">9. Disclaimer of warranties</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">10. Limitation of liability</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">11. Termination</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">12. Governing law</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-semibold text-heading">13. Contact</h2>
            <p className="mt-3">
              Questions about these Terms: <a href="mailto:legal@scantient.com" className="text-heading underline hover:no-underline">legal@scantient.com</a>. Scantient Inc., Chicago, Illinois.
            </p>
          </section>
        </div>
      </article>
