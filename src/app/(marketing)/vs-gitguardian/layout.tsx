...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "GitGuardian vs Scantient: External Security Scanning for Indie Devs",
    description:
      "GitGuardian alternative for indie devs. Scantient scans your live deployed app, not your git history, for API keys, CORS issues, and runtime security gaps.",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "No. Scantient requires no GitHub integration, no repository access, and no code installation. Paste your deployed app URL and get security scan results in 60 seconds. This external scanning approach tests what real attackers see: your live application, not your source code.",
      },
    },
  ],
};
