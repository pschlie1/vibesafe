          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div>
              ...
              <ul className="space-y-3">
                {[
                  "You need to audit the full network perimeter, not only your web app",
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-24">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-5 text-base leading-relaxed text-dusty-denim-700 dark:text-dusty-denim-400">
            ...
            <p>
              But HostedScan's pricing and feature depth is calibrated for IT teams and small businesses with recurring security budgets. If you're a developer who deployed a Next.js app and wants to know if your API is leaking secrets or missing CSP headers, HostedScan is more tool than you need, and you'll pay for it accordingly.
            </p>
            <p>
              Scantient trades breadth for speed and focus. No network port scanning. No SBOM. No enterprise compliance workflows. What you get instead: the fastest path from deploy to "I know my API security posture," and a lifetime deal that means you never pay again.
            </p>
            <p>
